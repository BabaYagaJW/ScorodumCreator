...
class json_struct():
        ...
        def structure_main_settings(self, Name_Game, Theme_Game, Client_Game, Date_Game, remove_answer, one_for_all, question_bet, all_in, team_bet, Mail_OnClick):
                structure_main = {
                        "game": {
                                "game_info": {
                                        "name": Name_Game,
        ...
        def unit_test(self):
                ...
                print(self.structure_main_settings("test", "test", "test", "test", "test", "test", "test", "test", "test2", "test"))
