...
class mainFormLogic(QMainWindow):
    ...
    def on_double_click_round(self):
        window_round = RoundLogic(self.list_round, self, self.quest_dict, self.ui.All_Round.count(), self.ui.All_Round.currentRow(), self.round_dict, self.Save_main_settings, "doubleclick")
    ...
    def on_add_round(self):
        ...
        self.hide()
        window_round = RoundLogic(self.list_round, self, self.quest_dict, self.ui.All_Round.count(), self.ui.All_Round.currentRow(), self.round_dict, self.Save_main_settings, "addclick")
    ...
    def on_del_round(self, count_del_round):
            try:
